...
subtitle: "Unleashing Kolkata's Data Potential: Let's Make Every Data Point Count with R"
...
![](collage_cu.jpg){fig-align="center" width="559"}
...
The inception of Kolkata R UseR group marks the unique convergence of passion, expertise and a shared vision intersecting with vibrant culture of the city for advancing data science and statistics within our community. Founded by two ardent R enthusiasts, [Samrit Pramanik](https://www.linkedin.com/in/samritpramanik24/), a seasoned data scientist equipped with an MSc in Statistics from Calcutta University, and his friend [Abhirup Moitra](https://www.linkedin.com/in/abhirup-moitra-7a66731a6/), currently pursuing MSc in Math and Data Science from IMA, our group sets out on a mission to cultivate a dyanamic ecosystem where R users of all level can thrive.
...
The integration of R programming and statistics elevates Kolkata as a center of *intellectual inquiry and scientific exploration*. R complements statistical methodologies, enhancing analysis, modeling, and visualization. Its indispensability spans academia and industry, reflecting Kolkata's commitment to advancing statistical knowledge. The **Kolkata R User Group (KRUG)** plays a vital role in promoting R programming across educational institutions, fostering data literacy and analytical thinking. Their efforts enrich Kolkata's cultural and intellectual landscape for future generations.
